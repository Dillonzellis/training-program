  ...
  return (
    <MainWrapper>
      <MaxWidthWrapper>
        ...
        <H2>Chest B</H2>
        <WorkoutList exerciseList={chestB} storageKey={STORAGE_KEY} onClear={handleClearChecks} />
        <H2>Triceps B</H2>
        <WorkoutList exerciseList={tricepsB} storageKey={STORAGE_KEY} onClear={handleClearChecks} />
        <H2>Shoulders B</H2>
        <WorkoutList exerciseList={shouldersB} storageKey={STORAGE_KEY} onClear={handleClearChecks} />
